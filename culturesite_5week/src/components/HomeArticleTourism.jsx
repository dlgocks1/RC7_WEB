...
import tourismVedio from "../assets/video/fireworks.mp4";

function HomeArticleTourism() {
    ...
    return (
        <Article>
            <CampintContetnInfo
                style={popupStyle}
                ref={setTarget}>
                <CampingText>관광</CampingText>
                <h2>오늘만 존재하는</h2>
                <h2>특별한 경험을 놓치지 마세요.</h2>
                <button>내 주변의 관광 정보 얻기</button>
            </CampintContetnInfo>
            <BackgroundImg src={tourismVedio} muted={true} autoPlay={true} loop={true}/>
...
export default HomeArticleTourism;