        ...
        <BillboardRow aria-label="특별 소개 콘텐츠">
            <TestContainer>
                ...
                <div style={{ position: "relative", width: "100%", overflow: "hidden" }}>
                    <video onEnded={()=>
                        setPlaying(false)
                    } src={mainvedio} autoPlay muted style={isPlaying===false ? {visibility : "hidden",position:"relative",left:"0",right:"0",top:"0",width:"100%"} : {visibility : "visible",position:"relative",left:"0",right:"0",top:"0",width:"100%"}} />
                </div>
            ...
            {/* <!-- 자막 및 내용 --> */}
            <div style={{top : "0",bottom:"20%",right:"0",left:"0",position:"absolute"}}>
                <Info>
                    <div>
...
export default SeriesSpecialContent;
