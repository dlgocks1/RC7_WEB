...
import LocalRankingList from "views/main/LocalRankingList";
import ViewContainer from "views/main/ViewContainer";
import styled from "styled-components"
import SeriesSpecialContent from "./seriesSpecialContent";
  ...
  useEffect(() => {
    setListContent([
    {
        ...
        contentList: [
        {
            ...
            name: `기묘한 이야기`,
            imgUrl:
            "https://occ-0-3076-988.1.nflxso.net/dnm/api/v6/X194eJsgWBDE2aQbaNdmCXGUP-Y/AAAABQenisw5aCqp5wMDYxQOOEzwKDlAtsh4Kpihxvgnc2YbuwySNe5bdX6fkpN0aeuvaieYMZis_rdJJ0QjGGar3wucebsIbyqj1GakkpgClHa9ktq5yRJEE4aacuboksTUnRgE_vQsXTLGo2uyXxpkc3GzbqN3Xuj6phIHDF5RZLjQ37bqS567Ls8MaVeqp9cPY2iQX7trGeJrXACRwAO5I8D1Oy5ICKtS.jpg?r=b6b",
        },
        {
            id: 2,
            name: `별에서온 그대`,
        ...
        },
        {
            ...
            name: `인간수업`,
            imgUrl:
            "https://occ-0-3076-988.1.nflxso.net/dnm/api/v6/X194eJsgWBDE2aQbaNdmCXGUP-Y/AAAABTMkcviwSLSw9FGXhReam6Elgwr_F6LkrE4na_6eW13blPQJKBj3ipTE1NHipezeHctQCEdGAyhf-6k5-pz2kbov8cPhusVy71hogWfnTgioawAE55Sh1R3DdErijUeeFMD1.jpg?r=345",
        },
        {
            id: 10,
            name: `솔로지옥`,
    ...
    },
    {
        ...
        contentList: [
        {
            ...
            name: `이상한 변호사 우영우`,
            imgUrl:
            "https://occ-0-3076-988.1.nflxso.net/dnm/api/v6/X194eJsgWBDE2aQbaNdmCXGUP-Y/AAAABeGq6o5YLXt9MxC3uhvBUsgA6n9-Yzm39kQlBzmnbNsu0pRUtdAf8IEfwIKGIdmxgX8MPD9GKvwAy3XV1QlOoNoM_LtOzI1LwcwVUkEK1JaYnHo6I8Ekd_btOU5FHJehjtHZCqCLkw.webp?r=54c",
        },
        {
            id: 14,
            name: `종이의 집`,
