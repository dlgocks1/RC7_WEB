    ...
    return (
        <MemberFooter>
            <div style={{marginBottom:"2em",display:"flex"}}>
                <a style={{marginRight:"15px"}} href="https://www.facebook.com/NetflixKR" target="_blank"
                    aria-label="facebook">
                    <SnsIcon width="24" height="24" viewBox="0 0 24 24" fill="none"
                ...
                <a style={{marginRight:"15px"}} href="https://www.instagram.com/netflixkr/" target="_blank"
                ...
                <a style={{marginRight:"15px"}} href="https://twitter.com/netflixkr" target="_blank"
                    aria-label="twitter">
                    <SnsIcon width="24" height="24" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path fillRule="evenodd" clopRule="evenodd"
            ...
            <MemberFooterLinks>
                <MemberFooterLinkWrapper>
                    <a className="member-footer-link" href="/browse/subtitles"><span
                        className="member-footer-link-content">자막 및 음성</span></a>
                        </MemberFooterLinkWrapper>
                <MemberFooterLinkWrapper>
                ...
                <MemberFooterLinkWrapper>
                    <a className="member-footer-link" href="/redeem"><span
                        className="member-footer-link-content">기프트카드</span></a></MemberFooterLinkWrapper>
                <MemberFooterLinkWrapper><a className="member-footer-link"
                    href="https://media.netflix.com/"><span className="member-footer-link-content">미디어 센터</span></a>
                </MemberFooterLinkWrapper>
                <MemberFooterLinkWrapper><a className="member-footer-link" href="http://ir.netflix.com/"><span
                ...
                <MemberFooterLinkWrapper><a className="member-footer-link"
                    href="https://help.netflix.com/legal/termsofuse"><span className="member-footer-link-content">이용
                        약관</span></a></MemberFooterLinkWrapper>
                <MemberFooterLinkWrapper><a className="member-footer-link"
                    href="https://help.netflix.com/legal/privacy"><span
                        className="member-footer-link-content">개인정보</span></a></MemberFooterLinkWrapper>
                <MemberFooterLinkWrapper><a className="member-footer-link"
                    href="https://help.netflix.com/legal/notices"><span className="member-footer-link-content">법적
                        고지</span></a></MemberFooterLinkWrapper>
                <MemberFooterLinkWrapper><a className="member-footer-link" href="/Cookies"><span
                    className="member-footer-link-content">쿠키 설정</span></a></MemberFooterLinkWrapper>
                <MemberFooterLinkWrapper><a className="member-footer-link"
                    href="https://help.netflix.com/legal/corpinfo"><span className="member-footer-link-content">회사
                        정보</span></a></MemberFooterLinkWrapper>
                <MemberFooterLinkWrapper><a className="member-footer-link"
