...
function FooterLogin() {
  ...
  return (
    <LoginFooter>
      ...
      >
        질문이 있으신가요? 문의 전화: &nbsp;
        <a className={cx(newLocal)} href="tel:080-001-9587">
          080-001-9587
        </a>
      </p>
      <Memberfooterlinks>
  ...
  return (
    <>
      {type === 'login' ? (
        ...
        <div role="contentinfo" className={cx('member-footer')}>
          <p style={{ margin: '16px 0' }} className={cx('footer-top')}>
            질문이 있으신가요? 문의 전화: &nbsp;
            <a className={cx('footer-top-a')} href="tel:080-001-9587">
              080-001-9587
            </a>
          </p>
          <ul className={cx('member-footer-links')}>
            <li className={cx('member-footer-link-wrapper')}>
              <a className={cx('member-footer-link')} href="/browse/subtitles">
                <span className={cx('member-footer-link-content')}>
                  자막 및 음성
                </span>
              </a>
            </li>
            <li className={cx('member-footer-link-wrapper')}>
              <a
                className={cx('member-footer-link')}
            ...
            <li className={cx('member-footer-link-wrapper')}>
              <a className={cx('member-footer-link')} href="/redeem">
                <span className={cx('member-footer-link-content')}>
                  기프트카드
                </span>
              </a>
            ...
            <li className={cx('member-footer-link-wrapper')}>
              <a className={cx('member-footer-link')} href="/Cookies">
                <span className={cx('member-footer-link-content')}>
                  쿠키 설정
                </span>
              </a>
